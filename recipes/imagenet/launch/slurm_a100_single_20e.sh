#!/bin/bash
#SBATCH --job-name=grlnet_a100_20e
#SBATCH -p gpu_A100
#SBATCH --gres=gpu:1
...
OUTPUT_DIR="${OUTPUT_DIR:-/home/faenna/grl/runs/grlnet_a100_single_20e}"
CONFIG_PATH="${CONFIG_PATH:-$REPO_DIR/recipes/imagenet/configs/grl_a100_single_20e.yaml}"
