#!/bin/bash
#SBATCH --job-name=grlnet_t4_4node_smoke
#SBATCH -p gpunode
#SBATCH --nodes=4
...
OUTPUT_DIR="${OUTPUT_DIR:-/home/faenna/grl/runs/grlnet_t4_4node_smoke}"
CONFIG_PATH="${CONFIG_PATH:-$REPO_DIR/recipes/imagenet/configs/grl_t4_4node_smoke.yaml}"
