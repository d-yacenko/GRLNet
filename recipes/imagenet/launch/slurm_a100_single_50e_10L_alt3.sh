...
OUTPUT_DIR="${OUTPUT_DIR:-/home/faenna/grl/runs/grlnet_a100_single_50e_10L_alt3}"
CONFIG_PATH="${CONFIG_PATH:-$REPO_DIR/recipes/imagenet/configs/grl_a100_single_50e_10L_alt3.yaml}"
