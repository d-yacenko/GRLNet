#!/bin/bash
#SBATCH --job-name=grlnet_a100_50e_w224_nc
#SBATCH -p gpu_A100
#SBATCH --gres=gpu:1
...
OUTPUT_DIR="${OUTPUT_DIR:-/home/faenna/grl/runs/grlnet_a100_single_50e_wide224_auxh_noclip}"
CONFIG_PATH="${CONFIG_PATH:-$REPO_DIR/recipes/imagenet/configs/grl_a100_single_50e_balanced_auxh_noclip.yaml}"
